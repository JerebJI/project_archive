...
\@x{ {\VARIABLE} rmState}%
\@pvspace{8.0pt}%
 \@x{ TCTypeOK \.{\defeq} rmState \.{\in} [ RM \.{\rightarrow} \{\@w{working}
 ,\,\@w{prepared} ,\,\@w{committed} ,\,\@w{aborted} \} ]}%
\@pvspace{8.0pt}%
 \@x{ TCConsistent \.{\defeq} \A\, r1 ,\, r2 \.{\in} RM \.{:} {\lnot}
 \.{\land} rmState [ r1 ] \.{=}\@w{aborted}}%
\@x{\@s{160.30} \.{\land} rmState [ r2 ] \.{=}\@w{committed}}%
\@pvspace{8.0pt}%
 \@x{ TCInit \.{\defeq} rmState \.{=} [ r \.{\in} RM \.{\mapsto}\@w{working}
 ]}%
\@pvspace{8.0pt}%
\@x{ Prepare ( r ) \.{\defeq} \.{\land} rmState [ r ] \.{=}\@w{working}}%
 \@x{\@s{65.81} \.{\land} rmState \.{'}\@s{8.04} \.{=} [ rmState {\EXCEPT}
 {\bang} [ r ] \.{=}\@w{prepared} ]}%
\@pvspace{8.0pt}%
...
\@pvspace{8.0pt}%
 ...
 \.{\neq}\@w{committed}}%
\@pvspace{8.0pt}%
 \@x{ Decide ( r ) \.{\defeq} \.{\lor} \.{\land} rmState [ r ]
 \.{=}\@w{prepared}}%
\@x{\@s{72.83} \.{\land} canCommit}%
 \@x{\@s{72.83} \.{\land} rmState \.{'} \.{=} [ rmState {\EXCEPT} {\bang} [ r
 ] \.{=}\@w{committed} ]}%
 \@x{\@s{61.72} \.{\lor} \.{\land} rmState [ r ] \.{\in} \{\@w{working}
 ,\,\@w{prepared} \}}%
\@x{\@s{72.83} \.{\land} notCommitted}%
 \@x{\@s{72.83} \.{\land} rmState \.{'} \.{=} [ rmState {\EXCEPT} {\bang} [ r
 ] \.{=}\@w{aborted} ]}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 31 20:00:14 \ensuremath{CEST} 2023 by \ensuremath{janezij
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Jul} 31
 18:59:06 \ensuremath{CEST} 2023 by \ensuremath{janezij
}%
\end{cpar}%
\end{lcom}%
\end{document}
